...
import { Alert, Box, Divider, Group, Image, Paper, Stack, Text, Title } from "@mantine/core";
    ...
    <Paper p="xl" shadow="xl" withBorder>
      <Stack gap="md">
        ...
        <Alert
          ...
          variant="light"
        >
          Once you proceed to the next step, the details can no longer be edited. Your appointment
          will only be confirmed after the payment is successfully received.
        </Alert>
