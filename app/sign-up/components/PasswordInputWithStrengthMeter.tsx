...
const PasswordInputWithStrengthMeter = ({ label = "Password" }: { label?: string }) => {
  const {
    register,
    formState: { errors },
          ...
          >
            <PasswordInput
              ...
              {...register("password", {
                ...
                validate: {
                  haveLowerCase: (value) =>
                    /[a-z]/.test(value) || "Password must have atleast one lowercase letter.",
                  haveUpperCase: (value) =>
                    /[A-Z]/.test(value) || "Password must have atleast one uppercase letter.",
